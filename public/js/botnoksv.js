...
//	var wards = getParamValue("w");
	...
	$.ajax({
		dataType: "json",
		url: "/getListMemberKsv?psid="+document.getElementById("psid").value,
		data: objMember,
...
//			}
			...
			{
				strRow= strRow+ '<td scope="col" width="87px"><img src="img/Accept.png" alt="Duyệt" onClick="#"/></td>';
				strRow= strRow+ '<td scope="col" width="87px"> <img type="image" src="img/cancel2.png" alt="Từ chối" onClick="#"/> </td>';
				
			}else if(obj.BlockStatus=='ACTIVE')
			{
				strRow= strRow+ '<td scope="col" width="87px"><img src="img/ok.png" alt="Đã chọn"/></td>';
				strRow= strRow+ '<td scope="col" width="87px" style="text-align: center">.</td>';
				
			}else if(obj.BlockStatus=='CANCEL')
			{
				strRow= strRow+ '<td scope="col" width="87px">.</td>';
				strRow= strRow+ '<td scope="col" width="87px" style="text-align: center"><img src="img/ok1.png" alt="Đã chọn"/></td>';
			}
...
//			row.cells[2].innerHTML='<td scope="col" width="87px"><input type="image" src="img/Accept.png" alt="Duyệt" onClick="AccpetMember(this);return false;"/></td>';
